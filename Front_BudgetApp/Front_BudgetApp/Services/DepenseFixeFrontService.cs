    ...
    public async Task<Result<IReadOnlyList<DepenseFixeDto>>> GetDepenses()
    {
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return Result.Fail(HttpErrorHelper.GetUserMessage(response, "Récupération des dépenses fixes"));
            }
    ...
    public async Task<Result<DepenseFixeDto>> Add(DepenseFixeForm depenseForm)
    {
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return Result.Fail(HttpErrorHelper.GetUserMessage(response, "Ajout dépense fixe"));
            }
    ...
    public async Task<Result> Update(int id, DepenseFixeForm depenseForm)
    {
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return Result.Fail(HttpErrorHelper.GetUserMessage(response, "Mise à jour dépense fixe"));
            }
    ...
    public async Task<Result> Delete(int id)
    {
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return Result.Fail(HttpErrorHelper.GetUserMessage(response, "Suppression dépense fixe"));
            }
    ...
    public async Task<Result> ChangeVuRappel(int id)
    {
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return Result.Fail(HttpErrorHelper.GetUserMessage(response, "Modification rappel"));
            }
